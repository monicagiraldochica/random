...
def get_jobInfo_sacct(job_id):
    ...
    """
    fields = [ "User", "State", "ExitCode", "DerivedExitCode", "Elapsed", "Timelimit", "Submit", "Start", "End", "Partition", "NodeList", "ReqCPUS", "AllocCPUS", "ReqMem", "AllocMem" ]
    #, "Command", "StdErr", "StdOut", "AveRSS", "MaxRSS", "WorkDir"
