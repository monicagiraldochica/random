...
def get_jobInfo_sacct(job_id):
    ...
    """
    fields = [ "User", "State", "ExitCode", "DerivedExitCode", "Elapsed", "Timelimit", "Submit", "Start", "End" ]
    #, "Partition", "NodeList", "ReqTRES", "AllocTRES", "Command", "StdErr", "StdOut", "AveRSS", "MaxRSS", "WorkDir"
